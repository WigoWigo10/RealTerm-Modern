...
uses
  ...
  StdCtrls, ExtCtrls, Spin, ComCtrls, ToolWin, Buttons,
  checklst, Menus, TrayIcon, Mask, AppEvnts,

  { === Unidades de Bibliotecas Obsoletas (Desativadas Temporariamente) === }
  {
  AdPort, AdWnPort, AdProtcl, {AdTerm,} AdSocket,
  AdStatLt,AdWUtil, {AdIniDB,} adExcept,
  ADTrmEmu, AdPStat, AdPacket,
  PortIO, {verslab,}
  OoMisc,
  StBase, StWmDCpy, StFirst,
  {TVicCommUnit,} StExpr, StVInfo,
  sc,
  }

  { === Unidades do Próprio Projeto (Manter) === }
  Paramlst,
  PicProgN,
  AFVersionCaption,
  { AdSpcEmu, -> MOVIDO PARA O BLOCO DE COMENTÁRIOS }
  realterm1, // Unidade principal do formulário
  I2Cx,
  ComportFinder,
  CRC8,
  HexEmulator,
